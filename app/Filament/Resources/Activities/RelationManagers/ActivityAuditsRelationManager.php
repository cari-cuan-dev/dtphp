...
// App\Filament\Resources\Activities\RelationManager\ActivityAuditsRelationManager
// /Volumes/Extend Mac/Git/CariCuanDev/dtphp/app/Filament/Resources/Activities/RelationManagers/ActivityAuditsRelationManager.php:25
...
class ActivityAuditsRelationManager extends RelationManager
{
    use HasExtraColumns;
    ...
    {
        return hexa()->can('activity.audit.index');
    }
    ...
    public function table(Table $table): Table
    {
        $tableActions = [
            ...
            RestoreAuditAction::make('restore')
                ->visible(fn()=> hexa()->can('activity.audit.restore')),
        ];
